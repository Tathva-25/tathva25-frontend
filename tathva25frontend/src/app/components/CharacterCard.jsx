  ...
  const characters = [
    {
      ...
      barcode: "||||||||||||",
      date: { d: "31", m: "12", y: "XX" },
      school: "KING OF CURSES - IMAGINARY DEMON - DISGRACED ONE",
      subtitle:
        "The most powerful curse in history with unmatched cursed energy and malevolent presence.",
      status: "HOSTILE",
    },
    {
      id: 2,
      ...
      subtitle:
        "Special Grade Sorcerer and Tokyo Jujutsu High's strongest educator, wielder of Limitless and Six Eyes.",
      status: "ACTIVE",
    },

    {
      ...
      surname: "TOJI",
      image:
        "https://setlivewallpaper.com/wp-content/uploads/2023/11/Toji-Fushiguro-thumb.png",
      color: {
        primary: "#000000",
        accent: "#ffffff",
        bg: "#1a1a1a",
      ...
      barcode: "||||||||||||",
      date: { d: "31", m: "12", y: "XX" },
      school: "ZENIN FAMILY - TIME VESSEL ASSOCIATION",
      subtitle:
        "Born with zero cursed energy yet became one of the most feared assassins through sheer physical prowess.",
      status: "DECEASED",
    },
  ];
