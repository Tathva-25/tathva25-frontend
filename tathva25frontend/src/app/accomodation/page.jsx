  ...
  const renderInitialView = () => (
    <div className="text-center p-4 sm:p-8 animate-fade-in">
      ...
      <button
        ...
        className="w-full max-w-md mx-auto bg-gradient-to-r from-gray-600 to-gray-400 text-white py-4 px-6 rounded-2xl font-semibold flex items-center justify-center space-x-2 hover:scale-105 transition-all duration-300 shadow-lg"
      >
        ...
        <div className="flex gap-3">
          {["male", "female"].map((gender) => (
            <button
              ...
              className={`flex-1 py-3.5 rounded-2xl font-semibold transition-all duration-300 shadow-sm border-2 ${
              ...
              {progressSteps.map((pStep, index) => (
                <React.Fragment key={pStep.id}>
                  <div className="flex flex-col items-center gap-2">
                    ...
                    <span
                      className={`text-xs font-semibold ${
                        step >= pStep.id ? "text-gray-800" : "text-gray-400"
                      }`}
                    >
                      {pStep.name}
                    </span>
                  ...
                  {index < progressSteps.length - 1 && (
                    <div
                      className={`w-16 h-1 mt-[-24px] rounded-full transition-all duration-500 ${
                        step > pStep.id
