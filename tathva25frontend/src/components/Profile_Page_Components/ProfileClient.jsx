...
export default function ProfileClient({ user }) {
    ...
    const renderActions = () => <div className="space-y-4"><button onClick={handleCopyReferral} className={`w-full ${copied ? "bg-green-500" : "bg-yellow-500 hover:bg-yellow-600"} text-black py-3 rounded-lg font-bold flex items-center justify-center gap-2 transition-all duration-300 shadow-lg`}>{copied ? <><FaCheck size={16} /> Copied!</> : <><FaShare size={16} /> Refer a Friend</>}</button><button onClick={() => { localStorage.removeItem("jwt"); router.push("/"); }} className="w-full bg-gray-100 hover:bg-gray-200 text-gray-800 font-bold transition-colors duration-200 py-3 rounded-lg flex items-center justify-center gap-2">Logout</button></div>;
        ...
        <>
            ...
            <div className="min-h-screen bg-gray-100 p-8 hidden xl:flex flex-col gap-8 font-sans">
                <div className="flex-1 flex gap-8">
                    ...
                    <main className="flex-1 flex flex-col bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 min-w-[450px]">
                    ...
                    <aside className="w-96 flex flex-col gap-8 flex-shrink-0 overflow-hidden">
                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200"><h2 className="text-xl font-bold text-gray-900 mb-6">Actions</h2>{renderActions()}</div>
                        <div className="bg-white p-6 rounded-2xl shadow-lg border border-gray-200"><h2 className="text-xl font-bold text-gray-900 mb-6">Personal Information</h2>{renderPersonalInfo()}</div>
                    </aside>
                </div>
            </div>
            ...
            <div className="min-h-screen bg-gray-100 p-8 hidden md:flex xl:hidden flex-col gap-8 font-sans">
                <div className="flex-1 flex gap-8">
                    ...
                    <main className="flex-1 flex flex-col bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-200 min-w-[400px]">
