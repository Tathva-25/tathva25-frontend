...
const COMPETITIONS_DATA = [
  {
    ...
    location: "Global",
    image:
      "https://images.unsplash.com/photo-1633356122544-f134324ef6db?w=500&h=600&fit=crop",
  ...
  },
  {
    ...
    location: "Las Vegas",
    image:
      "https://images.unsplash.com/photo-1538481143235-c8f91553dc11?w=500&h=600&fit=crop",
  ...
  },
  {
    ...
    location: "Dubai",
    image:
      "https://images.unsplash.com/photo-1552820728-8ac41f1ce891?w=500&h=600&fit=crop",
  ...
  },
  {
    ...
    location: "Seoul",
    image:
      "https://images.unsplash.com/photo-1511379938547-c1f69b13d835?w=500&h=600&fit=crop",
  ...
  },
  {
    ...
    location: "Tokyo",
    image:
      "https://images.unsplash.com/photo-1559056169-641ef2588fd3?w=500&h=600&fit=crop",
  ...
  },
  {
    ...
    location: "Miami",
    image:
      "https://images.unsplash.com/photo-1550355291-bbee04a92027?w=500&h=600&fit=crop",
  ...
  return (
    ...
    >
      ...
      <div className="relative w-full h-full transition-transform duration-500 transform group-hover:scale-105">
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-br ${competition.accentColor} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300`}
        />
        ...
        <div className="absolute inset-0 flex flex-col justify-end p-6 rounded-2xl">
          ...
          <div className="mb-4 inline-flex items-center gap-2 w-fit">
            <div
              className={`w-2 h-2 rounded-full bg-gradient-to-r ${competition.accentColor}`}
            />
          ...
          <div className="mb-3">
            ...
            <h3
              className="text-2xl font-bold text-white group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:bg-clip-text transition-all duration-300"
              style={{
      ...
      <div className="relative z-10 px-6 py-16 md:py-20">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-gray-400 text-lg max-w-2xl">
            Scroll down to explore competitions. Click any card to learn more
            and register.
          </p>
        </div>
      </div>
